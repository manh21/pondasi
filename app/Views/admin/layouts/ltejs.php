...
<!-- Datatable -->
<?php print_script_resource('assets/admin/plugins/datatables/jquery.dataTables.min.js') ?>
<?php print_script_resource('assets/admin/plugins/datatables-bs4/js/dataTables.bootstrap4.min.js') ?>
<?php print_script_resource('assets/admin/plugins/datatables-responsive/js/dataTables.responsive.min.js') ?>
<?php print_script_resource('assets/admin/plugins/datatables-responsive/js/responsive.bootstrap4.min.js') ?>
<!-- Select2 -->
<?php print_script_resource('assets/admin/plugins/select2/js/select2.full.js') ?>